...
Times start when the lid goes on: six minutes for soft-boiled with small eggs (or six and a half for large), nine minutes for almost hard with a soft center (or nine and a half for large), and ten minutes for hard-boiled (or ten and a half for large). That is the whole list, and the method does not change with the number of eggs.
